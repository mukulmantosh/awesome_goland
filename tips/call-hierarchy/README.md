...
![demo](./call_hierarchy.gif)

**Call Hierarchy** allows you to quickly see all the places where a function or method is used.

Press <kbd>âŒ¥^H</kbd> (macOS) / <kbd>Ctrl+Alt+H</kbd> (Windows/Linux), and the _Call Hierarchy_ tool window will open up with all the places that the function is called inside.
